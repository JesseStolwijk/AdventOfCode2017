import edu.jesse.adventofcode2017.Day2CorruptionChecksum
import org.assertj.core.api.Assertions.assertThat
import org.junit.jupiter.api.Test

internal class Day2CorruptionChecksumTest {

    private val day2CorruptionChecksum = Day2CorruptionChecksum()

    @Test
    fun corruptionChecksumTest() {
        // Prepare
        val spreadsheet =
            "5\t1\t9\t5\n" +
            "7\t5\t3\n" +
        ...
        // Execute
        val result = day2CorruptionChecksum.run(arrayOf(spreadsheet))
        // Verify
        assertThat(result).isEqualTo("18")
    }

    @Test
    fun corruptionChecksumTesChallengeInput() {
        // Prepare
        val input = "1640\t590\t93\t958\t73\t1263\t1405\t1363\t737\t712\t1501\t390\t68\t1554\t959\t79\n" +
        ...
        // Execute
        val result = day2CorruptionChecksum.run(arrayOf(input))

        // Verify
        assertThat(result).isEqualTo("48357")
    }
}